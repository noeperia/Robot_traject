...
class State:
    ...
    def __init__(self, x=0.0, y=0.0, yaw=0.0, v=0.0):
        ...
        self.v = v          # Vitesse 
        self.dyaw = 0.0
        liste_waypoint.append(Points(47.29,50)) # Point central #y=-0.74
...
def main():
    ...
    n = 0 
    while n < len(x):
        pchem = Points(x[n],y[n])
        liste_cheminpure.append(pchem)
        n += 1
    print(liste_cheminpure)
